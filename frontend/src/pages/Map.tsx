  ...
  const { viewBox, paths, circles } = useMemo(() => {
    ...
    for (const feature of filteredFeatures) {
      ...
      const district: DistrictInfo = {
        ...
        population: Number(
          props.census_2021_population ?? props.population ?? 0,
        ),
        ...
        <div className="border-r border-border">
          <div className="p-4 border-b border-border-light">
            ...
            <p className="font-mono text-[10px] uppercase tracking-widest text-text-muted mt-1">
              Ink choropleth - province tint at 6% / hover 14% / selected ink
              reversed
            </p>
          </div>
          <div className="p-4">
                  ...
                  return (
                    <g
                      ...
                      onMouseEnter={(e) => {
                        ...
                        setFill(
                          p as SVGPathElement | null,
                          color === "#050505" ? "#1a1a1a" : color,
                        );
                        (p as SVGPathElement | null)?.setAttribute(
                          "fill-opacity",
                          "0.14",
                        );
                      }}
