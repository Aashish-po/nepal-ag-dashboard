...
import { Menu, X, Home, BarChart3, Cloud, GitCompare, Sprout, LineChart, Map, Layers, Info, Activity } from 'lucide-react'
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Commercialization', href: '/commercialization', icon: Activity },
    ],
  },
  {
    label: 'SYSTEM',
            ...
            {navGroups.map((group) => (
              <div key={group.label}>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-mono text-[10px] uppercase tracking-widest text-text-muted px-1">{group.label}</span>
                  <div className="h-px flex-1 bg-border-light" />
                </div>
